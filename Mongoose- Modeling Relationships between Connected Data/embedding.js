...
mongoose.connect('mongodb://localhost/playground-modelling-2')
  ...
  // addAuthor('5b8d9c752af5cb7130206e55', new Author({ name: 'Anu' }))
  createCourse('Node Course', [
    new Author({ name: 'Chinmay' }),
    new Author({ name: '@chinmay29hub' })
  ]);
